...
from .views import PersonaViewSet, obtener_cursos_por_profesor, agregar_cursos_a_profesor, eliminar_curso_de_profesor
...
urlpatterns = [
    ...
    path('cursos/<int:id_profesor>/', obtener_cursos_por_profesor, name='obtener_cursos_por_profesor'),
